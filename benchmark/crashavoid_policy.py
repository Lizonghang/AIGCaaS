...
class CrashAvoidPolicy(BasePolicy):
    """Implementation of crash avoid policy. This policy assign user tasks to service
    providers with maximum available resources.
